...
// GET /api/attendance?month=2026-07  → dates that have sessions
// GET /api/attendance?date=2026-07-16 → session + attendance for that date
...
// POST /api/attendance — create session + mark attendance
// Body: { date: "2026-07-16", memberIds: ["id1", "id2"] }
